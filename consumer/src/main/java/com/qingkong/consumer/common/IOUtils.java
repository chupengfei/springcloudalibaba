...
public class IOUtils {
    ...
    public static void main(String[] args) throws IOException {
        Reader reader = new FileReader(new File("/Users/chupengfei/a.txt"));
        Writer writer = new FileWriter(new File("/Users/chupengfei/v.txt"));
       // IOUtils.copy(reader,writer);
        System.out.println(IOUtils.readLines(reader));
       IOUtils.writeStringToFile(new File("/Users/chupengfei/v.txt"),
               "kjlk","UTF-8");
    }
}
